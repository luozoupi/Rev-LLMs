...
class ReversibleQwenPerformanceTester:
    ...
    def setup_models_for_comparison(self, vocab_size=10000, hidden_size=512*4, 
    ...
    def measure_computational_efficiency(self, model, dataloader, max_batches=10):
    ...
    def calculate_enhanced_language_metrics(self, model, dataloader, max_batches=20):
...
if __name__ == "__main__":
    ...
    print("Running ENHANCED WikiText benchmarking...")
    
    # Run enhanced comprehensive test
    results = tester.run_comprehensive_test(
        seq_len=256*4,  # Start smaller for debugging
        vocab_size=16000*2,  # Manageable vocab size
        use_wikitext=True
    )
    ...
    if results:
        ...
        if fig:
            plt.savefig('enhanced_reversible_qwen_comparison.png', dpi=300, bbox_inches='tight')
            plt.show()
            print("Enhanced visualization saved!")
        
        # Save enhanced results
        tester.save_enhanced_results(results)
