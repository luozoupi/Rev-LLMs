...
class Qwen3CandidateDecoderLayer(nn.Module): #New Candidate Decoder Layer
    def __init__(self, config: Qwen3CandidateConfig, layer_idx: int):
        ...
        if config.use_candidate_selection and layer_idx in config.candidate_layers:
            self.self_attn = Qwen3CandidateSelectionAttention(
                config=config, 
                layer_idx=layer_idx,
                pr_ratio=config.candidate_pr_ratio,
